...
mongoose.connect(`mongodb://admin:password@3.22.112.235:27017/?directConnection=true`,{maxPoolSize: 5}).then(db => console.log('conexion exitosa')).catch(err => console.log('error: ', err))
